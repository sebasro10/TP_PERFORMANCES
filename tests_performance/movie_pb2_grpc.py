...
class MovieStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetListMovies = channel.unary_unary(
                '/Movie/GetListMovies',
                request_serializer=movie__pb2.Empty.SerializeToString,
                response_deserializer=movie__pb2.MovieDataArray.FromString,
                )
...
def add_MovieServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetListMovies': grpc.unary_unary_rpc_method_handler(
                    servicer.GetListMovies,
                    request_deserializer=movie__pb2.Empty.FromString,
                    response_serializer=movie__pb2.MovieDataArray.SerializeToString,
            ),
...
class Movie(object):
    ...
    def GetListMovies(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/GetListMovies',
            movie__pb2.Empty.SerializeToString,
            movie__pb2.MovieDataArray.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
